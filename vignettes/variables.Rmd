...
<sup>*</sup> Interpretations of LandMapR variables are derived from the LandMapR
C++ User Manual, October 2003
...
Note that variables prefaced by `st`, `n2`, `cr`, `pit`, and `peak` were only
...
p <- tribble(
  ~param,       ~landmapr,    ~desc,
  "zone",       "ZONE",       
  "convex_d",   "CONVEX_D",  "Likelihood of being convex in downslope direction",
  "concave_d",  "CONCAVE_D",
  "planar_d",   "PLANAR_D",
  "convex_a",   "CONVEX_A",
  "concave_a"   "CONCAVE_A",
