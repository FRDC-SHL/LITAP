...
3. __Calculating Watershed Area__ (`watershed_area`)
Calculate the total area of each watershed

4. __Initial Pit Removal__ (`local`)
...
5. __Calculating Pond Shed Statistics Second Pit Removal)__ (`pond`)
Calculate how pits would overflow into each other

6. __Calculating Fill Shed Statistics (Third Pit Removal)__ (`fill`)

7. __Calculating Directions on Inverted DEM__ (`inverted`)
...
8. __Calculating Inverted Watersheds__ (`iwatersheds`)
From the flow directions, combine cells into initial watersheds

9. __Calculating Inverted Watershed Area__ (`iwatershed_area`)
Calculate the total area of each watershed

10. __Initial Inverted Pit Removal__ (`ilocal`)
