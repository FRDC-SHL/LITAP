...
In the following examples, we will be using the output from complete run on the supplied "testELEV.dbf". You can find these files in the LITAP folder by using the `system.file()` function:
...
These files were created using the `complete_run()` function (see the [Getting Started Vignette](../LITAP.html))
...
local_stats <- readRDS(list.files(files, pattern = "testELEV_local.rds", full.names = TRUE))
```
...
gridExtra::grid.arrange(flow_plot(initial_dem, type = "elevation", dir = TRUE, upslope_threshold = 0) + ggplot2::labs(title = "0") + ggplot2::theme(legend.position = "none"),
                        flow_plot(initial_dem, type = "elevation", dir = TRUE, upslope_threshold = 10) + ggplot2::labs(title = "10") + ggplot2::theme(legend.position = "none"),
                        flow_plot(initial_dem, type = "elevation", dir = TRUE, upslope_threshold = 20) + ggplot2::labs(title = "20") + ggplot2::theme(legend.position = "none"),
                        flow_plot(initial_dem, type = "elevation", dir = TRUE, upslope_threshold = 40) + ggplot2::labs(title = "75") + ggplot2::theme(legend.position = "none"),
                        flow_plot(initial_dem, type = "elevation", dir = TRUE, upslope_threshold = 75) + ggplot2::labs(title = "200") + ggplot2::theme(legend.position = "none"),
                        flow_plot(initial_dem, type = "elevation", dir = TRUE, upslope_threshold = 500) + ggplot2::labs(title = "500") + ggplot2::theme(legend.position = "none"),
                        ncol = 2)
