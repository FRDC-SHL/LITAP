...
if(length(stringr::str_subset(files, paste0(run, "_pit.rds"))) > 0) cat(stringr::str_subset(files, paste0(run, "_pit.rds"))) #pit <- readRDS(stringr::str_subset(files, paste0(run, "_pit.rds")))
