...
if(length(stringr::str_subset(files, paste0(run, "_pit.rds"))) > 0) pit <- readRDS(stringr::str_subset(files, paste0(run, "_pit.rds"))) else pit <- NULL #cat(stringr::str_subset(files, paste0(run, "_pit.rds"))) 
if(length(stringr::str_subset(files, paste0(run, "_pond.rds"))) > 0) pond <- readRDS(stringr::str_subset(files, paste0(run, "_pond.rds"))) else pond <- NULL
if(length(stringr::str_subset(files, paste0(run, "_fill.rds"))) > 0) fill <- readRDS(stringr::str_subset(files, paste0(run, "_fill.rds"))) else fill <- NULL
```
